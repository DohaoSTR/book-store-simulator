...
{
    public class Brochure : DataBaseEntity
    {
        ...
        public Brochure(int printedMatter, int conformityDeclaration,
        ...
        public Brochure(long? id, int printedMatter, int conformityDeclaration,
            int stateRegistrationCertificate, int sanitaryEpidemiologicalCertificate)
            : base(id)
        {
            PrintedMatter = (PrintedMatter)GetEntity(printedMatter, new PrintedMatter());
        ...
        public override string TableName => "brochure";
        ...
        public override List<DataBaseEntity> GetEntityData(List<Dictionary<string, string>> result)
        {
            ...
            {
                DataBaseEntity entity = new Brochure(Convert.ToInt32(g["id"]),
