    ...
    public class ConformityCertificate : DataBaseEntity
    {
        ...
        public DateTime EndDate
        {
            ...
            set => _endDate = value.Date < RegistrationDate.Date
                ? throw new ArgumentOutOfRangeException("Дата окончания действия сертификата " +
        ...
        public ConformityCertificate(long? id, int registrationNumber,
        ...
        public override string TableName => "conformity_certificate";
        ...
        public override List<DataBaseEntity> GetEntityData(List<Dictionary<string, string>> result)
        {
            ...
            {
                DataBaseEntity entity = new ConformityCertificate(Convert.ToInt32(g["id"]), Convert.ToInt32(g["registration_number"]), g["code_transport_union"],
